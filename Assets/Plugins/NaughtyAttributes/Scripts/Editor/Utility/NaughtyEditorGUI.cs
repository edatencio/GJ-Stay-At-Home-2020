    ...
    public static class NaughtyEditorGUI
    {
        public static void PropertyField_Layout(SerializedProperty property, bool includeChildren)
        {
            ...
            else
            {
                ...
                {
                    // Drawer attributes check for visibility, enableability and validator
                    // themselves, so if a property doesn't have a DrawerAttribute we need to check
        ...
        /// </summary>
        /// <param name="rect">
        /// The rect the defines the position and size of the dropdown in the inspector
        /// </param>
        ...
        /// <param name="dropdownField">
        /// The field of the target object that holds the currently selected dropdown value
        /// </param>
            ...
            string label, int selectedValueIndex, object[] values, string[] displayOptions)
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                // TODO: Problem with structs, because they are value type. The solution is to make
                // boxing/unboxing but unfortunately I don't know the compile time type of the
                // target object
